rule get_aligned_pos:
    ...
    output:
        aligned_files=temp("results/QC/{sample}/{sample}-{unit}.aligned.txt"),
    log:
...
rule get_selected_transcripts_aligned_read_bins:
    input:
        aligned_file="results/QC/{sample}/{sample}-{unit}.aligned.txt",
    ...
    output:
        fwrd_allsamp_hist_fil=temp(
            "results/QC/{sample}/{sample}-{unit}.{ind_transcripts}.aligned-fwd-fil-read-bins.txt"
        ),
...
use rule get_selected_transcripts_aligned_read_bins as get_aligned_read_bins with:
    output:
        fwrd_allsamp_hist=temp(
            "results/QC/{sample}/{sample}-{unit}.{ind_transcripts}.aligned-fwd-full-read-bins.txt"
        ),
        fwrd_allsamp_hist_trim=temp(
            "results/QC/{sample}/{sample}-{unit}.{ind_transcripts}.aligned-fwd-trim-read-bins.txt"
        ),
        rev_allsamp_hist=temp(
            "results/QC/{sample}/{sample}-{unit}.{ind_transcripts}.aligned-rev-full-read-bins.txt"
        ),
        rev_allsamp_hist_trim=temp(
            "results/QC/{sample}/{sample}-{unit}.{ind_transcripts}.aligned-rev-trim-read-bins.txt"
        ),
    ...
    rule get_selected_transcripts_sample_QC_histogram:
        input:
            fwrd_allsamp_hist_fil=expand(
                "results/QC/{unit.sample}/{unit.sample}-{unit.unit}.{ind_transcripts}.aligned-fwd-fil-read-bins.txt",
                unit=units.itertuples(),
                ind_transcripts="{ind_transcripts}",
            ),
            rev_allsamp_hist_fil=expand(
                "results/QC/{unit.sample}/{unit.sample}-{unit.unit}.{ind_transcripts}.aligned-rev-fil-read-bins.txt",
                unit=units.itertuples(),
                ind_transcripts="{ind_transcripts}",
            ),
            read_length="results/stats/max-read-length.json",
    ...
    rule get_sample_QC_histogram:
        input:
            fwrd_allsamp_hist=expand(
                "results/QC/{unit.sample}/{unit.sample}-{unit.unit}.{ind_transcripts}.aligned-fwd-full-read-bins.txt",
                unit=units.itertuples(),
                ind_transcripts="{ind_transcripts}",
            ),
            fwrd_allsamp_hist_trim=expand(
                "results/QC/{unit.sample}/{unit.sample}-{unit.unit}.{ind_transcripts}.aligned-fwd-trim-read-bins.txt",
                unit=units.itertuples(),
                ind_transcripts="{ind_transcripts}",
            ),
            rev_allsamp_hist=expand(
                "results/QC/{unit.sample}/{unit.sample}-{unit.unit}.{ind_transcripts}.aligned-rev-full-read-bins.txt",
                unit=units.itertuples(),
                ind_transcripts="{ind_transcripts}",
            ),
            rev_allsamp_hist_trim=expand(
                "results/QC/{unit.sample}/{unit.sample}-{unit.unit}.{ind_transcripts}.aligned-rev-trim-read-bins.txt",
                unit=units.itertuples(),
                ind_transcripts="{ind_transcripts}",
            ),
            read_length="results/stats/max-read-length.json",
