...
#transcript_ids ="ENST00000394351.9"


samples = snakemake.params["samples"]
#samples = "results/kallisto_cds/Mel-86c_p49_Ctrl-1"
...
filtered_transcript_data.to_csv("/home/manuel/paschen-quantseq-melanoma/MITF/Mel-86c_p49_Ctrl-1_filtered_read_data.tsv", sep='\t', index=False)
aligned_reads.to_csv("/home/manuel/paschen-quantseq-melanoma/MITF/Mel-86c_p49_Ctrl-1_filtered_min_read_dist-data.tsv", sep='\t', index=False)
...
if fwrd_flag == 1:
    ...
    Rev_chart =alt.hconcat(rev_chart_full)
