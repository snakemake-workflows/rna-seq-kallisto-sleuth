...
align_bam_txt = pd.read_csv(snakemake.input['canonical_mapped_pos'], 
...
aligned_reads.to_csv(snakemake.output['canonical_mapped_3prime_pos'],columns=['read_name'], sep='\t', index=False)
