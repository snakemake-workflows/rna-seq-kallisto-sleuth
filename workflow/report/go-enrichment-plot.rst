**Network plot of enriched gene ontology (GO) terms** with enrichment determined and plot created by goatools, using the sleuth model ``{{ snakemake.params.model["full"] }}``. 
