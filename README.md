...
![Github Action](https://github.com/snakemake-workflows/rna-seq-kallisto-sleuth/workflows/Testing/badge.svg)
...
6. Run the analysis.
7. Optional: Merge back any valuable and generalizable changes to the [upstream repo](https://github.com/snakemake-workflows/rna-seq-kallisto-sleuth) via a [**pull request**](https://help.github.com/en/articles/creating-a-pull-request). This would be **greatly appreciated**.
